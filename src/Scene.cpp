...
//    std::shared_ptr<Light> light2 = std::make_shared<Light>(glm::vec3(1.0f, 1.0f, 1.0f), 0.1f);
    std::shared_ptr<Light> light3 = std::make_shared<Light>(glm::vec3(1.0f, 1.0f, 1.0f), 10.0f, glm::vec3(-2.0f, 0.0f, -1.0f));
